<template>
    <section class="bg-primary p-8 md:p-[10.5rem] relative md:pt-[16rem]">
        <img
            src="./../assets/light-accent-3.svg"
            alt=""
            class="absolute top-0 left-0"
        />
        <img
            src="./../assets/light-accent-4.svg"
            alt=""
        ...
        <div class="flex flex-col gap-5 mb-5">
            ...
            <div class="flex items-center cursor-pointer gap-5">
                <span class="text-sm text-custom-yellow">
                    View all Mzoori POS features
                </span>
                <img
                    src="./../assets/chevron-right-yellow.svg"
                    alt="chevron right"
                    class="h-5"
                />
            </div>
            ...
            <div class="flex items-center justify-between">
                <div class="flex flex-col space-y-6 lg:-mt-5">
                    ...
                    >
                        ...
                        <div class="flex items-center cursor-pointer gap-5">
                            <span class="text-xs text-primary/75">
                                Book a call
                            </span>
                            <img
